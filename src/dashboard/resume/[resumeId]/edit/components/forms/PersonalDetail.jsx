...
function PersonalDetail({ enabledNext }) {
    ...
    const handleImageUpload = (image) => {
        ...
        // Dodaj obraz do formData
        setFormData((prevData) => ({
            ...prevData,
            photo: image, // Dodanie obrazu do formData
        }));
    
        // Zaktualizuj resumeInfo, jeśli potrzebne
        setResumeInfo((prevInfo) => ({
            ...prevInfo,
            photo: image,
        }));
        console.log("Uploaded image:", image); // Debug
    };
    ...
    const onSave = (e) => {
        ...
        console.log("Form data before sending:", formData); // Dodanie logowania przed wysłaniem danych
            ...
            <form onSubmit={onSave}>
                <div className='grid grid-cols-2 mt-6 gap-3'>
                    <div className='col-span-2'>
                        ...
                        <ImageUploader name='photo' defaultValue={resumeInfo?.photo} required onChange={handleInputChange} onImageUpload={handleImageUpload} />
                    </div>
                    <div>
